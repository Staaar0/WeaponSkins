...
public sealed record PaintDef(int Paint, string Name, float MinFloat, float MaxFloat, bool Legacy, string Image);
...
public sealed record AgentDef(string Model, string Name, CsTeam Team, string Faction, string Image);
