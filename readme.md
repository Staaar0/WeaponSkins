...
## NOTE:
inspect codes from [csfloat](https://csfloat.com/db) and [steam](https://steamcommunity.com/market/search?appid=730) does work but the inspects link contain this `//` if you want to ues inspect links from both you must remove one of the `//`
